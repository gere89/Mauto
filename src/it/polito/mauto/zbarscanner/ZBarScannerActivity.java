package it.polito.mauto.zbarscanner;

import it.polito.mauto.activity.GameActivity;
...
//		mPreview.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT));
//      viewContainer.addView(mPreview);
