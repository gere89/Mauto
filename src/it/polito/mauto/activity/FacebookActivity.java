...
public class FacebookActivity extends FragmentActivity {
    ...
    private final String PENDING_ACTION_BUNDLE_KEY = "it.polito.mauto.activity:PendingAction";
...
//        });
		...
		if(intent.getStringExtra("post").compareTo("only_post")==0){
			postStatusUpdate();
...
//        pickPlaceButton.setEnabled(enableButtons);
    ...
    public void postStatusUpdate() {
        if (user != null && hasPublishPermission()) {
        	//Log.w("SONO QUIIII", "SONO QUIIII");
            final String message = "Ho sbloccato Motore per l'auto!"; //getString(R.string.status_update, user.getFirstName(), (new Date().toString()));
    ...
    private void postPhoto() {
        if (hasPublishPermission()) {
            ...
            Request request = Request.newUploadPhotoRequest(Session.getActiveSession(), image, "Teste Caption", "teste description", new Request.Callback() {
                @Override
                public void onCompleted(Response response) {
